 ...
 * @param {string | string[] | ((requestOrigin: string, context: FreshContext) => string | undefined | null)} [options.origin='*'] - The value of "Access-Control-Allow-Origin" CORS header.
 ...
 * @returns {(request: Request, context: FreshContext) => Promise<Response>} The Fresh middleware handler function.
 *
 * @example
 * ```ts
